...
import React__default, { useMemo, useState, useCallback, useEffect, useRef, createContext, forwardRef, useContext, useLayoutEffect } from 'react';
import { useElementScroll, useSpring, motion, motionValue, useMotionValue } from 'framer-motion';
...
const ScrollProvider = forwardRef((_a, ref) => {
    ...
    return (React__default.createElement(ScrollContext.Provider, { value: scroll },
        React__default.createElement(motion.div, { style: { display: 'none', x: velocityX, y: velocityY } }),
        React__default.createElement(motion.div, Object.assign({}, otherProps, { ref: ref, style: Object.assign({ scrollBehavior: 'smooth', overflow: 'auto' }, style) }), children)));
});
const useScroll = () => {
...
const Container = forwardRef((_a, forwardedRef) => {
...
const Section = forwardRef((_a, forwardedRef) => {
    ...
    return (React__default.createElement(SectionContext.Provider, { value: context },
        React__default.createElement(motion.div, Object.assign({}, otherProps, { ref: (el) => {
                assignRef(forwardedRef, el);
...
const Item = forwardRef((_a, forwardedRef) => {
...
export { Scroll, useScrollState, useScrollValue };
